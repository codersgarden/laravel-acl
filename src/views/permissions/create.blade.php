    ...
    <div class="content">
        ...
        <div class="ms-5 me-5 mt-4">
            ...
            <nav class="mb-3">
                ...
                <span class="fw-400">Add new Permission</span>
            </nav>

            <!-- Title -->
            <h2 class="title pt-2 text-uppercase">Add Permission</h2>
        </div>
        
        <div class="container mt-5 ">
            <form action="{{ route('permissions.store') }}" method="post" class="mx-auto rounded col-md-6 m-auto">
                @csrf
                <div class="mb-3">
